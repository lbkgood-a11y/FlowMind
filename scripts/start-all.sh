...
SERVICES_LIST="trio-base-services/service-auth,trio-base-services/service-org,trio-base-services/service-tenant,trio-base-services/service-lowcode,trio-base-services/service-workflow-engine,trio-base-services/service-openapi,trio-base-services/service-ops,trio-base-platform/platform-gateway"
...
nohup java -jar "${ROOT_DIR}/trio-base-services/service-tenant/target/service-tenant-0.1.0-SNAPSHOT.jar" > "${LOG_DIR}/service-tenant.log" 2>&1 &
...
echo "    Tenant  (8083):  $(curl -s -o /dev/null -w '%{http_code}' http://localhost:8083 2>/dev/null || echo 'DOWN')"
