...
$services = @(
    ...
    @{Name="service-api-runtime";       Port=8095; Jar="$rootDir\trio-base-services\service-api-runtime\target\service-api-runtime-0.1.0-SNAPSHOT.jar"},
...
if ($Rebuild -or -not (Test-Path $firstJar)) {
    ...
    $serviceList = "trio-base-services/service-auth,trio-base-services/service-org,trio-base-services/service-tenant,trio-base-services/service-lowcode,trio-base-services/service-workflow-engine,trio-base-services/service-api-runtime,trio-base-platform/platform-gateway"
