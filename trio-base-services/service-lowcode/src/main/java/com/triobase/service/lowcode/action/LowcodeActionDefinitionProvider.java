...
public class LowcodeActionDefinitionProvider implements ActionDefinitionProvider {
    ...
    private ActionDefinition formAction(String actionType, String permission) {
        ...
        definition.getRequiredGuards().add(ActionGuardRequirement.of(OWNER_SERVICE, "LOWCODE_FORM_ACTIONABLE", "低代码表单当前可执行"));
    ...
    private ActionDefinition workflowRetryAction() {
        ...
        definition.getRequiredGuards().add(ActionGuardRequirement.of(OWNER_SERVICE, "LOWCODE_WORKFLOW_RETRYABLE", "低代码工作流当前可重试"));
        definition.setPayloadSchemaJson("""
                {
                  "type": "object",
