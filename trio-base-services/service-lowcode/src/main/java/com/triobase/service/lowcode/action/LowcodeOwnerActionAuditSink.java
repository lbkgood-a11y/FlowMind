...
public class LowcodeOwnerActionAuditSink implements OwnerActionAuditSink {

    private static final Logger log = LoggerFactory.getLogger(LowcodeOwnerActionAuditSink.class);
    ...
    public void emit(ActionEventPayload event) {
        ...
        LowcodeActionAuditEvent audit = new LowcodeActionAuditEvent();
    ...
    private void pushToTimeline(ActionEventPayload event) {
        try {
            ...
            headers.set(InternalServiceTokenFilter.HEADER_SERVICE_NAME, "service-lowcode");
