...
import com.triobase.service.workflow.action.WorkflowOwnerHostedActionController;
...
class WorkflowActionArchitectureTest {
    ...
    void ownerHostedActionControllerExposesStandardEndpoints() throws NoSuchMethodException {
        assertStandardOwnerHostedEndpoints(WorkflowOwnerHostedActionController.class, "/api/v1/workflow-actions");
    }
