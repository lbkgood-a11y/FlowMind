...
public class WorkflowOwnerHostedActionController
        extends AbstractActionOwnerController<WorkflowActionOwnerExecutionService> {

    @Autowired
    public WorkflowOwnerHostedActionController(ObjectMapper objectMapper,
                                               List<ActionDefinitionProvider> providers,
                                               WorkflowActionOwnerExecutionService executionService,
    ...
    // -------------------------------------------------------------------
    // Endpoints — delegate to base class
    // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // Workflow-specific permission mapping
    // -------------------------------------------------------------------
