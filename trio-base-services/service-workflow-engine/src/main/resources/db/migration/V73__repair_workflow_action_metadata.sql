-- Repair workflow Action metadata when an environment has a successful V35
-- history entry but the physical columns are missing.  Every statement is
-- idempotent so healthy environments can apply this migration safely.
