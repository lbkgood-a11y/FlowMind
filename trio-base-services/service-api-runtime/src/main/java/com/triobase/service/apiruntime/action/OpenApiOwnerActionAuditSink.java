...
import com.triobase.common.openapi.entity.AuditEvent;
import com.triobase.service.apiruntime.infrastructure.mapper.AuditEventMapper;
...
public class OpenApiOwnerActionAuditSink implements OwnerActionAuditSink {
    ...
    private void pushToTimeline(ActionEventPayload event) {
        try {
            ...
            record.setOwnerService("service-api-runtime");
            ...
            headers.set(InternalServiceTokenFilter.HEADER_SERVICE_NAME, "service-api-runtime");
