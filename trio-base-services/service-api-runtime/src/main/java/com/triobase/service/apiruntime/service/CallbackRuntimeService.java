...
import com.triobase.service.apiruntime.action.OpenApiActionMetadata;
import com.triobase.service.apiruntime.infrastructure.mapper.CallbackInboxMapper;
import com.triobase.service.apiruntime.infrastructure.mapper.CallbackNonceMapper;
...
public class CallbackRuntimeService {
    ...
    private final CallbackProfileResolver profileResolver;
    ...
    public CallbackAcknowledgement receive(
        ...
        CallbackProfileVersion profile = profileResolver.resolvePublished(callbackKey, tenantId, environment);
