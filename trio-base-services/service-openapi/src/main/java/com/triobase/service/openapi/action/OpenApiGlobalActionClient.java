...
@Component
public class OpenApiGlobalActionClient {
    ...
    public OpenApiGlobalActionClient(InternalServiceSecurityProperties securityProperties,
    ...
    public GlobalActionResult submit(GlobalActionRequest request) {
        try {
            ...
            if (envelope == null || envelope.path("code").asInt(-1) != 0 || envelope.path("data").isMissingNode()) {
                throw new BizException(50275, "OPENAPI_GLOBAL_ACTION_FAILED");
            }
