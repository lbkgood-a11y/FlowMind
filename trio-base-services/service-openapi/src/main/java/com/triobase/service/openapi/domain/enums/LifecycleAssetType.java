...
public enum LifecycleAssetType {
    ...
    STRUCTURE_VERSIONS("structure-versions", "id", "structure_id", "lifecycle_state", "created_at"),
    MAPPINGS("mappings", "mapping_key", "display_name", "lifecycle_state", "created_at"),
    MAPPING_VERSIONS("mapping-versions", "id", "mapping_set_id", "lifecycle_state", "created_at"),
    VALUE_MAPS("value-maps", "value_map_key", "display_name", "lifecycle_state", "created_at"),
    VALUE_MAP_VERSIONS("value-map-versions", "id", "value_map_set_id", "lifecycle_state", "created_at"),
    CONNECTORS("connectors", "connector_key", "display_name", "lifecycle_state", "created_at"),
    CONNECTOR_VERSIONS("connector-versions", "id", "connector_endpoint_id", "lifecycle_state", "created_at"),
    ROUTES("routes", "route_key", "display_name", "lifecycle_state", "created_at"),
    ROUTE_VERSIONS("route-versions", "id", "route_definition_id", "lifecycle_state", "created_at"),
    ...
    ORCHESTRATION_VERSIONS("orchestration-versions", "id", "orchestration_definition_id", "lifecycle_state", "created_at"),
    CALLBACKS("callbacks", "callback_key", "display_name", "lifecycle_state", "created_at"),
    CALLBACK_VERSIONS("callback-versions", "id", "callback_profile_id", "lifecycle_state", "created_at"),
    PRODUCTS("products", "product_key", "display_name", "lifecycle_state", "created_at"),
    PRODUCT_VERSIONS("product-versions", "id", "semantic_version", "lifecycle_state", "created_at"),
    APPLICATIONS("applications", "application_key", "display_name", "lifecycle_state", "created_at"),
    APPLICATION_CLIENTS("application-clients", "client_key", "application_id", "lifecycle_state", "created_at"),
