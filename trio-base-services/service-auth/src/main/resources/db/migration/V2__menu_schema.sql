...
INSERT INTO sys_menu(id, parent_id, menu_key, menu_name, path, icon, menu_group, sort_order, visible, permission_id, description) VALUES
    ('M001', NULL, 'dashboard',   'Dashboard', '/',                  'LayoutDashboard', 'general', 10, 1, NULL,   '后台首页与平台概览'),
    ('M002', NULL, 'forms',       '表单管理',  '/forms',             'FileText',        'forms',   20, 1, 'P011', '表单列表与发布管理'),
    ('M003', NULL, 'form-create', '新建表单',  '/forms/new',         'FilePlus2',       'forms',   30, 1, 'P012', '创建新的低代码表单'),
    ('M004', NULL, 'users',       '用户管理',  '/admin/users',       'Users',           'admin',   40, 1, 'P001', '用户状态与角色分配'),
    ('M005', NULL, 'roles',       '角色管理',  '/admin/roles',       'Shield',          'admin',   50, 1, 'P005', '角色与权限绑定'),
    ('M006', NULL, 'menus',       '菜单管理',  '/admin/menus',       'ListTree',        'admin',   60, 1, 'P013', '后台菜单目录管理'),
    ('M007', NULL, 'permissions', '授权管理',  '/admin/permissions', 'KeySquare',       'admin',   70, 1, 'P016', '资源路径与动作级权限项')
ON CONFLICT DO NOTHING;
